...
import styles from './NewestProduct.module.scss';
  ...
  return (
    <div className="container">
      <div className="mb-5" style={{ marginTop: '50px' }}>
          ...
          <div className={cx('newest-product-owl-controls')}>
            <div className={cx('newest-product-owl-nav')}>
              <div
                ...
                className={cx('newest-product-owl-prev')}
              >
                <FontAwesomeIcon
                  style={{
              ...
              <div
                ...
                className={cx('newest-product-owl-next')}
              >
                <FontAwesomeIcon
                  style={{
        ...
        <div className={cx('newest-product-wrapper')}>
          <div
            ref={hotProductListRef}
            style={{ transform: `translateY(${translateYValue}px)` }}
            className={`${cx('newest-product-list')} row`}
          >
            {newestProducts.map((newestProduct, index) => (
              ...
              >
                <ProductCard key={index} product={newestProduct} />
              </div>
            ))}
          </div>
        </div>
